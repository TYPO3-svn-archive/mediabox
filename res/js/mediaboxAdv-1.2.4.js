...
//			NonverBlaster
				...
				playerpath: 'typo3conf/ext/mediabox/res/NonverBlaster.swf',	// Path to NonverBlaster.swf
				controlColor: '0xFFFFFF',	// set the controlbar color
				controlBackColor: '0x000000',	// set the controlbar color
				showTimecode: 'false',		// turn timecode display off or on
//			JW Media Player settings and options
				JWplayerpath: 'typo3conf/ext/mediabox/res/mediaplayer.swf',	// Path to the mediaplayer.swf or flvplayer.swf file
